...
const navLinks = document.querySelectorAll('#nav-menu li a'); // Pega todos os links do menu

// 1. Abrir e fechar o menu ao clicar nas 3 barrinhas
menuToggle.addEventListener('click', function() {
    navMenu.classList.toggle('show-menu');
});

// 2. Fechar o menu automaticamente ao clicar em qualquer opção
navLinks.forEach(link => {
    link.addEventListener('click', function() {
        navMenu.classList.remove('show-menu'); // Remove a classe que mostra o menu
    });
});